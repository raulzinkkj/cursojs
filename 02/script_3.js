// as variáveis com let não podem ser declaradas 2 vezes no mesmo escopo

var name = "Raul";
var name = "Elcio"; //isto vai funcionar, mas não é uma boa prática

let age = "50";
let age = "60";  //isto vai dar erro, pois não e possivel declarar a variável 2 vezes no mesmo escopo
